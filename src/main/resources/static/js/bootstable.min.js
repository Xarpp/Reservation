        ...
        error: function(jqXHR, textStatus, errorThrown) {
            ...
            if (jqXHR.responseJSON) {
                ...
                errorMessages.forEach(function(message) {
                    ...
                    console.error(message); // Например, выводим сообщение об ошибке в консоль
                });
            } else {
                showNotification("Неизвестная ошибка. Изменения не внесены.", false);
...
function rowAcep(t) {
    ...
    var data = {
        ...
        host: {
            hostID: i.eq(6).find('input, select').val()[0]
        },
